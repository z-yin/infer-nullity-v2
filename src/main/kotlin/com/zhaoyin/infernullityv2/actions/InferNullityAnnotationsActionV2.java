 ...
 */
package com.zhaoyin.infernullityv2.actions;
...
import com.zhaoyin.infernullityv2.core.NullityInferrer;
import com.zhaoyin.infernullityv2.tasks.AnnotateTask;
...
public class InferNullityAnnotationsActionV2 extends BaseAnalysisAction {
    @NonNls
    ...
    public InferNullityAnnotationsActionV2() {
    ...
    private Factory<UsageSearcher> rerunFactory(@NotNull final Project project, @NotNull final AnalysisScope scope) {
        return () -> new UsageInfoSearcherAdapter() {
            ...
            protected UsageInfo @NotNull [] findUsages() {
                return ObjectUtils.notNull(InferNullityAnnotationsActionV2.this.findUsages(project, scope, scope.getFileCount()), UsageInfo.EMPTY_ARRAY);
            }
